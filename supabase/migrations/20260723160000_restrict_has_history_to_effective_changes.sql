-- has_history yalnızca stok durumunu GERÇEKTEN değiştirmiş kayıtları saymalı — reddedilen
-- bir miktar/ekleme talebi hiçbir şeyi değiştirmedi, geri alınmış (reversed_at dolu) bir
-- fazla satın alma eklemesi de artık geçerli değil. Önceki sürüm bunları da has_history'ye
-- dahil ediyordu, bu yüzden Malzeme Listesi'ndeki kırmızı "!" işareti reddedilmiş talebi
-- olan ama hiç onaylı değişikliği olmayan kalemlerde de yanlışlıkla görünüyordu.
