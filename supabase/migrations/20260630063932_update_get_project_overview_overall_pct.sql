...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    -- ── Tarihe göre süzülmüş gerçek ilerleme ─────────────────────────────────
    -- progress_items.task_id bağlantısına gerek duymadan,
    -- tüm progress_items için p_end_date'e kadar birikimli ortalama yüzde.
