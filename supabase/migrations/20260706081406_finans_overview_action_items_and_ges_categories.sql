...
BEGIN
  ...
  -- GES'e özgü 6 maliyet kovası: Panel/İnverter/Konstrüksiyon/Kablo & Elektrik planı budget_lines'tan
  -- birebir doğru; ama invoices.category yalnızca malzeme/iscilik/diger düzeyinde tutulduğu için bu 4
  -- malzeme kovasının gerçekleşen/bekleyen tutarı, o kovanın PLANLANAN bütçe içindeki ağırlığına göre
  -- orantılı dağıtılarak hesaplanır (İşçilik ve Diğer için veri zaten birebir gerçek).
  WITH bucket_map AS (
