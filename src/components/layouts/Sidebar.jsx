...
export default function Sidebar({ active, onTab, onLogout }) {
  ...
  const items = [
    ...
    {
      key: 'raporlar', label: 'AI Raporlar',
      roles: ['admin'],
      icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2a10 10 0 1 0 10 10"/><path d="M12 8v4l3 3"/><path d="M18 2v4h4"/><path d="M22 2l-4 4"/></svg>,
    },
    {
